...
import Headphone4 from "../assets/image/headphone4.png"
            ...
            <div className="container py-14 grid grid-cols-1 md:grid-cols-2 space-y-6 md:space-y-0 gap-12">
                ...
                <div>
                    <motion.img
                        ...
                        src={Headphone4} alt="Headpphone4" className="w-[300px] md:w-[400px] mx-auto" />
                </div>
                {/* Banner Text Info */}
                <div className="flex flex-col justify-center">
                    <div className="text-center md:text-left space-y-4 lg:max-w-[450px]">
                        ...
                        <motion.p
                            variants={fadeUp(0.9)}
                            initial="hidden"
                            whileInView="show">Lorem ipsum dolor sit amet consectetur adipisicing elit. Recusandae iusto minima ad ut id eos accusantium aut, aperiam quis incidunt!</motion.p>
